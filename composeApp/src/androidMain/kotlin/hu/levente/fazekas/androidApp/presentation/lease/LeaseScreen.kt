...
import hu.bme.aut.android.eszkozkolcsonzo.presentation.lease.LeaseDetail
import hu.bme.aut.android.eszkozkolcsonzo.presentation.lease.LeaseEvent
...
fun LeaseScreen(
    ...
    viewModel: LeaseViewModel = getViewModel()
) {
